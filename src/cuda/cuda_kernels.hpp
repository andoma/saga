...
void loss_bwd_half_float(int n, const __half *x, __half *dx, const float *dy,
                         float *loss, unsigned int c, float scale,
                         cudaStream_t stream);

void loss_bwd_half_half(int n, const __half *x, __half *dx, const __half *dy,
                        float *loss, unsigned int c, float scale,
                        cudaStream_t stream);

void loss_bwd_float_float(int n, const float *x, float *dx, const float *dy,
                          float *loss, unsigned int c, float scale,
                          cudaStream_t stream);
...
void adam_float(int n, float *weights, const float *gradients, float *mvec,
                float *vvec, float b1t, float b2t, float learning_rate,
                float l2_lambda, CudaAux *aux, cudaStream_t stream, int num_sm);
...
void adam_mixed(int n, float alpha, __half *weights, const __half *gradients,
                ...
                float learning_rate, float l2_lambda, CudaAux *aux,
