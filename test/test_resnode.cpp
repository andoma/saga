...
static int
expect(std::shared_ptr<Tensor> result,
       std::shared_ptr<Tensor> expect,
       const char *name)
{
...
SAGA_CLI_CMD("resnode",
             "resnode [OPTIONS ...]",
             "Run test of standard ResNet node",
             resnode_main);
